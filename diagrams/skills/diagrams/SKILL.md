---
name: diagrams
description: Draw diagrams (UML sequence, state, deployment, class; data flow / DFD with threat-model trust zones & boundaries; flowcharts) as hand-placed HTML/CSS, rendered to PNG.
