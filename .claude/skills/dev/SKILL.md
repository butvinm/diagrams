...
diagrams/                      the plugin (shipped)
  kit/primitives.css           box vocabulary + layout presets
...
tests/
  ...
  cases/<name>/ours.png        last render (regenerated by the harness)
  golden/<name>.png            blessed reference render
  diff/<name>.png              pixel diff on failure (regenerated)
